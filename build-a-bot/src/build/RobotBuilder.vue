<template>
    ...
    <div class="middle-row">
      <div class="left part">
        <img :src="availableParts.arms[selectedArmLeftIndex].src" title="left arm"/>
      ...
      <div class="right part">
        <img :src="availableParts.arms[selectedArmRightIndex].src" title="right arm"/>
 ...
 export default {
     ...
     methods: {
       ...
       selectNextLeftArm() {
         this.selectedArmLeftIndex = getNextValidIndex(this.selectedArmLeftIndex, availableParts.heads.length);
       },
       selectPrevLeftArm() {
         this.selectedArmLeftIndex = getPreviousValidIndex(this.selectedArmLeftIndex, availableParts.heads.length);
       },
       selectNextTorso() {
         this.selectedTorsoIndex = getNextValidIndex(this.selectedTorsoIndex, availableParts.heads.length);
       },
       selectPrevTorso() {
         this.selectedTorsoIndex = getPreviousValidIndex(this.selectedTorsoIndex, availableParts.heads.length);
       },
       selectNextRightArm() {
         this.selectedArmRightIndex = getNextValidIndex(this.selectedArmRightIndex, availableParts.heads.length);
       },
       selectPrevRightArm() {
         this.selectedArmRightIndex = getPreviousValidIndex(this.selectedArmRightIndex, availableParts.heads.length);
       },
       selectNextBase() {
         this.selectedBaseIndex = getNextValidIndex(this.selectedBaseIndex, availableParts.heads.length);
       },
       selectPrevBase() {
         this.selectedBaseIndex = getPreviousValidIndex(this.selectedBaseIndex, availableParts.heads.length);
       }
     }
 }
 </script>
